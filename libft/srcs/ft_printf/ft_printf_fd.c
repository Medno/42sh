...
/*   Updated: 2018/01/20 08:26:43 by kyazdani         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static int	ft_create_str(int fd, char *format, va_list list, t_colors colors)
{
	char	**array;
	char	*final_str;
	int		result;
...
int			ft_printf_fd(int fd, const char *format, ...)
{
	...
	result = ft_create_str(fd, (char *)format, list, colors);
	va_end(list);
	return (result);
}
